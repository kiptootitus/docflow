...
import { GoogleLogin, GoogleOAuthProvider } from "@react-oauth/google"; // 👈 Integrated Google module
...
export default function LoginPage() {
  ...
  // 👇 Handles token response handshake from Google client side script
  const handleGoogleSuccess = async (credentialResponse: any) => {
    ...
    try {
      ...
      // Initialize configuration parameters & redirect
      window.location.href = "/dashboard";
    } catch {
      setError("Google authentication synchronization failed.");
    }
  };

  return (
    // Wrap with the specific client credentials provider ID assigned inside your Google Developers Console
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-white flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            {/* 👇 GOOGLE SIGN IN BUTTON PLACED TOP LEVEL */}
            <div className="flex justify-center mb-5 w-full">
              <GoogleLogin
                onSuccess={handleGoogleSuccess}
                onError={() => setError("Google login process cancelled.")}
                theme="outline"
                size="large"
                width="100%"
              />
            ...
            <div className="relative flex py-2 items-center text-xs text-gray-400 uppercase mb-3">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  ...
                  {/* 👇 REDIRECTION ACCESS HOOK FOR RECOVERY LINK */}
